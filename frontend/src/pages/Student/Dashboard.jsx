...
import { LogOut, Home, Key, MessageCircle, FileText, CheckCircle, UserCircle } from 'lucide-react';
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="dashboard-main">
        {activeTab === 'overview' && (
          <>
            ...
            <section className="notices-section">
              <h2 className="notices-title">General Notifications</h2>
        ...
        {activeTab === 'profile' && (
            <Profile studentInfo={studentInfo} onProfileUpdate={fetchInfo} />
        )}
        
        {activeTab === 'room' && (
            <RoomDetails roomId={studentInfo?.cotId?.roomId?._id || studentInfo?.cotId?.roomId} />
        )}

        {activeTab === 'complaints' && <Complaints />}
        {activeTab === 'food' && <FoodSchedule />}
