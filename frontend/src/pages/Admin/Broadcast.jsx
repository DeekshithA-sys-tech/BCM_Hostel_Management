            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                {formData.targetScope === 'room' && (
                    <div>
                        ...
                        <input type="text" name="roomId" value={formData.roomId} onChange={handleChange} className="input-field" placeholder="Enter corresponding Object ID" required />
                    </div>
                )}
                ...
                {formData.targetScope === 'individual' && (
                    <div>
                        ...
                        <input type="text" name="studentId" value={formData.studentId} onChange={handleChange} className="input-field" placeholder="Enter corresponding Object ID" required />
                    </div>
                )}
